...
|------------- | ------------- | -------------|
| [**generateValidKey**](ProjectKeyAndNameValidationApi.md#generateValidKey) | **GET** /rest/api/3/projectvalidate/validProjectKey | Get valid project key |
...
| [**validateKeyString**](ProjectKeyAndNameValidationApi.md#validateKeyString) | **GET** /rest/api/3/projectvalidate/key | Validate project key |


<a name="generateValidKey"></a>
# **generateValidKey**
> String generateValidKey().key(key).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    String key = "HSP"; // The project key.
    try {
      ...
      System.err.println("Exception when calling ProjectKeyAndNameValidationApi#generateValidKey");
...
# **getValidProjectName**
> String getValidProjectName(name).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    configuration.password = "YOUR PASSWORD";
    AtlassianJira client = new AtlassianJira(configuration);
    String name = "name_example"; // The project name.
    try {
      String result = client
              .projectKeyAndNameValidation
              .getValidProjectName(name)
              .execute();
    } catch (ApiException e) {
...
<a name="validateKeyString"></a>
# **validateKeyString**
> ErrorCollection validateKeyString().key(key).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling ProjectKeyAndNameValidationApi#validateKeyString");
      System.err.println("Status code: " + e.getStatusCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
    ...
    // Use .executeWithHttpInfo() to retrieve HTTP Status Code, Headers and Request
    try {
      ApiResponse<ErrorCollection> response = client
              .projectKeyAndNameValidation
              .validateKeyString()
              .key(key)
              .executeWithHttpInfo();
