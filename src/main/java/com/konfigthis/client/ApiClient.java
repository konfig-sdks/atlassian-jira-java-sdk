...
public class ApiClient extends ApiClientCustom {
    ...
    private String tokenUrl = "https://auth.atlassian.com/oauth/token";
    ...
    private void init() {
        ...
        setUserAgent("Konfig/1001.0.0-SNAPSHOT-9aad01a33a3dae75a5b6aedf98c77d2cbd2f865d/java");
     ...
     * Set token url
     *
     * @param tokenUrl Token URL for oauth (e.g https://auth.atlassian.com/oauth/token)
     * @return An instance of OkHttpClient
     */
