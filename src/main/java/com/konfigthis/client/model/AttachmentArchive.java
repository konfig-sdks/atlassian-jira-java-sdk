...
import com.konfigthis.client.model.AttachmentArchiveEntry;
...
public class AttachmentArchive {
  ...
  **/
   ...
   * @return the AttachmentArchive instance itself
   */
  public AttachmentArchive putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.entries, attachmentArchive.entries) &&
        ...
        Objects.equals(this.additionalProperties, attachmentArchive.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(entries, moreAvailable, totalEntryCount, totalNumberOfEntriesAvailable, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AttachmentArchive.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<AttachmentArchive>() {
           ...
           public AttachmentArchive read(JsonReader in) throws IOException {
             ...
             AttachmentArchive instance = thisAdapter.fromJsonTree(jsonObj);
