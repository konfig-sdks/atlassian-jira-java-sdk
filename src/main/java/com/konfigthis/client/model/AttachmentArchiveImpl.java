...
public class AttachmentArchiveImpl {
  ...
  **/
   ...
   * @return the AttachmentArchiveImpl instance itself
   */
  public AttachmentArchiveImpl putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.entries, attachmentArchiveImpl.entries) &&
        ...
        Objects.equals(this.additionalProperties, attachmentArchiveImpl.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(entries, totalEntryCount, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AttachmentArchiveImpl.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<AttachmentArchiveImpl>() {
           ...
           public AttachmentArchiveImpl read(JsonReader in) throws IOException {
             ...
             AttachmentArchiveImpl instance = thisAdapter.fromJsonTree(jsonObj);
