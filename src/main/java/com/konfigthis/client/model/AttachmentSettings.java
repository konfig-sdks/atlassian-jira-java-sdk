 ...
 */
@ApiModel(description = "Details of the instance's attachment settings.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class AttachmentSettings {
  ...
  **/
   ...
   * @return the AttachmentSettings instance itself
   */
  public AttachmentSettings putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.enabled, attachmentSettings.enabled) &&
        ...
        Objects.equals(this.additionalProperties, attachmentSettings.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(enabled, uploadLimit, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AttachmentSettings.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<AttachmentSettings>() {
           ...
           public AttachmentSettings read(JsonReader in) throws IOException {
             ...
             AttachmentSettings instance = thisAdapter.fromJsonTree(jsonObj);
