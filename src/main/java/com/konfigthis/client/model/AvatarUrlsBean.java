...
public class AvatarUrlsBean {
  ...
  **/
   ...
   * @return the AvatarUrlsBean instance itself
   */
  public AvatarUrlsBean putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this._16x16, avatarUrlsBean._16x16) &&
        ...
        Objects.equals(this.additionalProperties, avatarUrlsBean.additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AvatarUrlsBean.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<AvatarUrlsBean>() {
           ...
           public AvatarUrlsBean read(JsonReader in) throws IOException {
             ...
             AvatarUrlsBean instance = thisAdapter.fromJsonTree(jsonObj);
