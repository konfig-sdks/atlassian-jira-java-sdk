 ...
 */
@ApiModel(description = "Details for changing owners of shareable entities")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class BulkChangeOwnerDetails {
  ...
  **/
   ...
   * @return the BulkChangeOwnerDetails instance itself
   */
  public BulkChangeOwnerDetails putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.autofixName, bulkChangeOwnerDetails.autofixName) &&
        ...
        Objects.equals(this.additionalProperties, bulkChangeOwnerDetails.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(autofixName, newOwner, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to BulkChangeOwnerDetails
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!BulkChangeOwnerDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<BulkChangeOwnerDetails>() {
           ...
           public BulkChangeOwnerDetails read(JsonReader in) throws IOException {
             ...
             BulkChangeOwnerDetails instance = thisAdapter.fromJsonTree(jsonObj);
