 ...
 */
@ApiModel(description = "Details of the options to create for a custom field.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class BulkCustomFieldOptionCreateRequest {
  ...
  **/
   ...
   * @return the BulkCustomFieldOptionCreateRequest instance itself
   */
  public BulkCustomFieldOptionCreateRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.options, bulkCustomFieldOptionCreateRequest.options)&&
        Objects.equals(this.additionalProperties, bulkCustomFieldOptionCreateRequest.additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!BulkCustomFieldOptionCreateRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<BulkCustomFieldOptionCreateRequest>() {
           ...
           public BulkCustomFieldOptionCreateRequest read(JsonReader in) throws IOException {
             ...
             BulkCustomFieldOptionCreateRequest instance = thisAdapter.fromJsonTree(jsonObj);
