 ...
 */
@ApiModel(description = "Details of project permissions and associated issues and projects to look up.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class BulkProjectPermissions {
  ...
  **/
   ...
   * @return the BulkProjectPermissions instance itself
   */
  public BulkProjectPermissions putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.issues, bulkProjectPermissions.issues) &&
        ...
        Objects.equals(this.additionalProperties, bulkProjectPermissions.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(issues, permissions, projects, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!BulkProjectPermissions.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      if (jsonObj.get("issues") != null && !jsonObj.get("issues").isJsonArray()) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<BulkProjectPermissions>() {
           ...
           public BulkProjectPermissions read(JsonReader in) throws IOException {
             ...
             BulkProjectPermissions instance = thisAdapter.fromJsonTree(jsonObj);
