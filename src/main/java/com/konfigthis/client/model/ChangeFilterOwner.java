 ...
 */
@ApiModel(description = "The account ID of the new owner.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ChangeFilterOwner {
  ...
  **/
   ...
   * @return the ChangeFilterOwner instance itself
   */
  public ChangeFilterOwner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accountId, changeFilterOwner.accountId)&&
        Objects.equals(this.additionalProperties, changeFilterOwner.additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ChangeFilterOwner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ChangeFilterOwner>() {
           ...
           public ChangeFilterOwner read(JsonReader in) throws IOException {
             ...
             ChangeFilterOwner instance = thisAdapter.fromJsonTree(jsonObj);
