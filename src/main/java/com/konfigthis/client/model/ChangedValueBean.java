 ...
 */
@ApiModel(description = "Details of names changed in the record event.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ChangedValueBean {
  ...
  **/
   ...
   * @return the ChangedValueBean instance itself
   */
  public ChangedValueBean putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.changedFrom, changedValueBean.changedFrom) &&
        ...
        Objects.equals(this.additionalProperties, changedValueBean.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(changedFrom, changedTo, fieldName, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ChangedValueBean>() {
           ...
           public ChangedValueBean read(JsonReader in) throws IOException {
             ...
             ChangedValueBean instance = thisAdapter.fromJsonTree(jsonObj);
