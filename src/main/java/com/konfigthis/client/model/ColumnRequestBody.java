...
public class ColumnRequestBody {
  ...
  **/
   ...
   * @return the ColumnRequestBody instance itself
   */
  public ColumnRequestBody putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.columns, columnRequestBody.columns)&&
        Objects.equals(this.additionalProperties, columnRequestBody.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ColumnRequestBody
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ColumnRequestBody.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ColumnRequestBody>() {
           ...
           public ColumnRequestBody read(JsonReader in) throws IOException {
             ...
             ColumnRequestBody instance = thisAdapter.fromJsonTree(jsonObj);
