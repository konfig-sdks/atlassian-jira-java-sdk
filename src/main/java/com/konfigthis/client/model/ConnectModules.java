...
public class ConnectModules {
  ...
  **/
   ...
   * @return the ConnectModules instance itself
   */
  public ConnectModules putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.modules, connectModules.modules)&&
        Objects.equals(this.additionalProperties, connectModules.additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ConnectModules.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ConnectModules>() {
           ...
           public ConnectModules read(JsonReader in) throws IOException {
             ...
             ConnectModules instance = thisAdapter.fromJsonTree(jsonObj);
