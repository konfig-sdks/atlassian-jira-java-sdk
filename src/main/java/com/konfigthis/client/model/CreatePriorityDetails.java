 ...
 */
@ApiModel(description = "Details of an issue priority.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class CreatePriorityDetails {
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CreatePriorityDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
