...
import com.konfigthis.client.model.NestedResponse;
 ...
 */
@ApiModel(description = "Details about a created issue or subtask.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class CreatedIssue {
  ...
  **/
  ...
  public CreatedIssue transition(NestedResponse transition) {
  ...
  **/
  ...
  public void setTransition(NestedResponse transition) {
  ...
  public CreatedIssue watchers(NestedResponse watchers) {
  ...
  **/
  ...
  public void setWatchers(NestedResponse watchers) {
   ...
   * @return the CreatedIssue instance itself
   */
  public CreatedIssue putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, createdIssue.id) &&
        ...
        Objects.equals(this.additionalProperties, createdIssue.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, key, self, transition, watchers, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CreatedIssue.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      if (jsonObj.get("transition") != null && !jsonObj.get("transition").isJsonNull()) {
        NestedResponse.validateJsonObject(jsonObj.getAsJsonObject("transition"));
      }
      // validate the optional field `watchers`
      if (jsonObj.get("watchers") != null && !jsonObj.get("watchers").isJsonNull()) {
        NestedResponse.validateJsonObject(jsonObj.getAsJsonObject("watchers"));
      }
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CreatedIssue>() {
           ...
           public CreatedIssue read(JsonReader in) throws IOException {
             ...
             CreatedIssue instance = thisAdapter.fromJsonTree(jsonObj);
