 ...
 */
@ApiModel(description = "The default value for a Forge collection of groups custom field.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class CustomFieldContextDefaultValueForgeMultiGroupField {
  ...
  **/
   ...
   * @return the CustomFieldContextDefaultValueForgeMultiGroupField instance itself
   */
  public CustomFieldContextDefaultValueForgeMultiGroupField putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.contextId, customFieldContextDefaultValueForgeMultiGroupField.contextId) &&
        ...
        Objects.equals(this.additionalProperties, customFieldContextDefaultValueForgeMultiGroupField.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(contextId, groupIds, type, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CustomFieldContextDefaultValueForgeMultiGroupField.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CustomFieldContextDefaultValueForgeMultiGroupField>() {
           ...
           public CustomFieldContextDefaultValueForgeMultiGroupField read(JsonReader in) throws IOException {
             ...
             CustomFieldContextDefaultValueForgeMultiGroupField instance = thisAdapter.fromJsonTree(jsonObj);
