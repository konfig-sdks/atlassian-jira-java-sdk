 ...
 */
@ApiModel(description = "The default value for a project custom field.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class CustomFieldContextDefaultValueProject {
  ...
  **/
   ...
   * @return the CustomFieldContextDefaultValueProject instance itself
   */
  public CustomFieldContextDefaultValueProject putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.contextId, customFieldContextDefaultValueProject.contextId) &&
        ...
        Objects.equals(this.additionalProperties, customFieldContextDefaultValueProject.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(contextId, projectId, type, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CustomFieldContextDefaultValueProject.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CustomFieldContextDefaultValueProject>() {
           ...
           public CustomFieldContextDefaultValueProject read(JsonReader in) throws IOException {
             ...
             CustomFieldContextDefaultValueProject instance = thisAdapter.fromJsonTree(jsonObj);
