 ...
 */
@ApiModel(description = "The default value for a group picker custom field.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class CustomFieldContextDefaultValueSingleGroupPicker {
  ...
  **/
   ...
   * @return the CustomFieldContextDefaultValueSingleGroupPicker instance itself
   */
  public CustomFieldContextDefaultValueSingleGroupPicker putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.contextId, customFieldContextDefaultValueSingleGroupPicker.contextId) &&
        ...
        Objects.equals(this.additionalProperties, customFieldContextDefaultValueSingleGroupPicker.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(contextId, groupId, type, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CustomFieldContextDefaultValueSingleGroupPicker.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CustomFieldContextDefaultValueSingleGroupPicker>() {
           ...
           public CustomFieldContextDefaultValueSingleGroupPicker read(JsonReader in) throws IOException {
             ...
             CustomFieldContextDefaultValueSingleGroupPicker instance = thisAdapter.fromJsonTree(jsonObj);
