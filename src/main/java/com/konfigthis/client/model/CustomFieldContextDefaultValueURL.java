 ...
 */
@ApiModel(description = "The default value for a URL custom field.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class CustomFieldContextDefaultValueURL {
  ...
  **/
   ...
   * @return the CustomFieldContextDefaultValueURL instance itself
   */
  public CustomFieldContextDefaultValueURL putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.contextId, customFieldContextDefaultValueURL.contextId) &&
        ...
        Objects.equals(this.additionalProperties, customFieldContextDefaultValueURL.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(contextId, type, url, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CustomFieldContextDefaultValueURL.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CustomFieldContextDefaultValueURL>() {
           ...
           public CustomFieldContextDefaultValueURL read(JsonReader in) throws IOException {
             ...
             CustomFieldContextDefaultValueURL instance = thisAdapter.fromJsonTree(jsonObj);
