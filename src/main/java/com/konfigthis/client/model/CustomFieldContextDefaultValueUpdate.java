 ...
 */
@ApiModel(description = "Default values to update.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class CustomFieldContextDefaultValueUpdate {
  ...
  **/
   ...
   * @return the CustomFieldContextDefaultValueUpdate instance itself
   */
  public CustomFieldContextDefaultValueUpdate putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.defaultValues, customFieldContextDefaultValueUpdate.defaultValues)&&
        Objects.equals(this.additionalProperties, customFieldContextDefaultValueUpdate.additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CustomFieldContextDefaultValueUpdate.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CustomFieldContextDefaultValueUpdate>() {
           ...
           public CustomFieldContextDefaultValueUpdate read(JsonReader in) throws IOException {
             ...
             CustomFieldContextDefaultValueUpdate instance = thisAdapter.fromJsonTree(jsonObj);
