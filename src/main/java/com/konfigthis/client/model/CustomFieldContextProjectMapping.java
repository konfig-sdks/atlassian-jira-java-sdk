 ...
 */
@ApiModel(description = "Details of a context to project association.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class CustomFieldContextProjectMapping {
  ...
  **/
   ...
   * @return the CustomFieldContextProjectMapping instance itself
   */
  public CustomFieldContextProjectMapping putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.contextId, customFieldContextProjectMapping.contextId) &&
        ...
        Objects.equals(this.additionalProperties, customFieldContextProjectMapping.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(contextId, isGlobalContext, projectId, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CustomFieldContextProjectMapping.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CustomFieldContextProjectMapping>() {
           ...
           public CustomFieldContextProjectMapping read(JsonReader in) throws IOException {
             ...
             CustomFieldContextProjectMapping instance = thisAdapter.fromJsonTree(jsonObj);
