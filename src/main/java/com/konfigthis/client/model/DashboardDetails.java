...
public class DashboardDetails {
  ...
  **/
   ...
   * @return the DashboardDetails instance itself
   */
  public DashboardDetails putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, dashboardDetails.description) &&
        ...
        Objects.equals(this.additionalProperties, dashboardDetails.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, editPermissions, name, sharePermissions, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DashboardDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<DashboardDetails>() {
           ...
           public DashboardDetails read(JsonReader in) throws IOException {
             ...
             DashboardDetails instance = thisAdapter.fromJsonTree(jsonObj);
