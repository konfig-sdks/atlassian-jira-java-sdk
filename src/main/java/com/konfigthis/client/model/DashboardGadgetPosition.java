 ...
 */
@ApiModel(description = "Details of a gadget position.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class DashboardGadgetPosition {
  ...
  **/
   ...
   * @return the DashboardGadgetPosition instance itself
   */
  public DashboardGadgetPosition putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.theColumnPositionOfTheGadget, dashboardGadgetPosition.theColumnPositionOfTheGadget) &&
        ...
        Objects.equals(this.additionalProperties, dashboardGadgetPosition.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(theColumnPositionOfTheGadget, theRowPositionOfTheGadget, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DashboardGadgetPosition.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<DashboardGadgetPosition>() {
           ...
           public DashboardGadgetPosition read(JsonReader in) throws IOException {
             ...
             DashboardGadgetPosition instance = thisAdapter.fromJsonTree(jsonObj);
