...
import com.konfigthis.client.model.DataClassificationTagBean;
...
public class DataClassificationLevelsBean {
  ...
  **/
   ...
   * @return the DataClassificationLevelsBean instance itself
   */
  public DataClassificationLevelsBean putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.classifications, dataClassificationLevelsBean.classifications)&&
        Objects.equals(this.additionalProperties, dataClassificationLevelsBean.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(classifications, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to DataClassificationLevelsBean
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DataClassificationLevelsBean.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      if (jsonObj.get("classifications") != null && !jsonObj.get("classifications").isJsonNull()) {
        ...
        if (jsonArrayclassifications != null) {
          ...
          for (int i = 0; i < jsonArrayclassifications.size(); i++) {
            DataClassificationTagBean.validateJsonObject(jsonArrayclassifications.get(i).getAsJsonObject());
          };
        }
      }
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<DataClassificationLevelsBean>() {
           ...
           public DataClassificationLevelsBean read(JsonReader in) throws IOException {
             ...
             DataClassificationLevelsBean instance = thisAdapter.fromJsonTree(jsonObj);
