 ...
 */
@ApiModel(description = "Details about the default workflow.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class DefaultWorkflow {
  ...
  **/
   ...
   * @return the DefaultWorkflow instance itself
   */
  public DefaultWorkflow putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.updateDraftIfNeeded, defaultWorkflow.updateDraftIfNeeded) &&
        ...
        Objects.equals(this.additionalProperties, defaultWorkflow.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(updateDraftIfNeeded, workflow, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DefaultWorkflow.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<DefaultWorkflow>() {
           ...
           public DefaultWorkflow read(JsonReader in) throws IOException {
             ...
             DefaultWorkflow instance = thisAdapter.fromJsonTree(jsonObj);
