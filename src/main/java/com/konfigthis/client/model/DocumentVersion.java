 ...
 */
@ApiModel(description = "The current version details of this workflow scheme.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class DocumentVersion {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "The version UUID.")
  ...
  **/
   ...
   * @return the DocumentVersion instance itself
   */
  public DocumentVersion putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, documentVersion.id) &&
        ...
        Objects.equals(this.additionalProperties, documentVersion.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, versionNumber, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to DocumentVersion
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DocumentVersion.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<DocumentVersion>() {
           ...
           public DocumentVersion read(JsonReader in) throws IOException {
             ...
             DocumentVersion instance = thisAdapter.fromJsonTree(jsonObj);
