...
public class Errors {
  ...
  **/
   ...
   * @return the Errors instance itself
   */
  public Errors putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.issueIsSubtask, errors.issueIsSubtask) &&
        ...
        Objects.equals(this.additionalProperties, errors.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(issueIsSubtask, issuesInArchivedProjects, issuesInUnlicensedProjects, issuesNotFound, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      if (jsonObj.get("issueIsSubtask") != null && !jsonObj.get("issueIsSubtask").isJsonNull()) {
        Error.validateJsonObject(jsonObj.getAsJsonObject("issueIsSubtask"));
      }
      ...
      if (jsonObj.get("issuesInArchivedProjects") != null && !jsonObj.get("issuesInArchivedProjects").isJsonNull()) {
        Error.validateJsonObject(jsonObj.getAsJsonObject("issuesInArchivedProjects"));
      }
      ...
      if (jsonObj.get("issuesInUnlicensedProjects") != null && !jsonObj.get("issuesInUnlicensedProjects").isJsonNull()) {
        Error.validateJsonObject(jsonObj.getAsJsonObject("issuesInUnlicensedProjects"));
      }
      // validate the optional field `issuesNotFound`
      if (jsonObj.get("issuesNotFound") != null && !jsonObj.get("issuesNotFound").isJsonNull()) {
        Error.validateJsonObject(jsonObj.getAsJsonObject("issuesNotFound"));
      }
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Errors>() {
           ...
           public Errors read(JsonReader in) throws IOException {
             ...
             Errors instance = thisAdapter.fromJsonTree(jsonObj);
