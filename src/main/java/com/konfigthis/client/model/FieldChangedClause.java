...
import com.konfigthis.client.model.JqlQueryClauseTimePredicate;
 ...
 */
@ApiModel(description = "A clause that asserts whether a field was changed. For example, `status CHANGED AFTER startOfMonth(-1M)`.See [CHANGED](https://confluence.atlassian.com/x/dgiiLQ#Advancedsearching-operatorsreference-CHANGEDCHANGED) for more information about the CHANGED operator.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class FieldChangedClause {
  ...
  **/
   ...
   * @return the FieldChangedClause instance itself
   */
  public FieldChangedClause putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.field, fieldChangedClause.field) &&
        ...
        Objects.equals(this.additionalProperties, fieldChangedClause.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(field, operator, predicates, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FieldChangedClause.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<FieldChangedClause>() {
           ...
           public FieldChangedClause read(JsonReader in) throws IOException {
             ...
             FieldChangedClause instance = thisAdapter.fromJsonTree(jsonObj);
