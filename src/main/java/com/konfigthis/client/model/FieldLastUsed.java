 ...
 */
@ApiModel(description = "Information about the most recent use of a field.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class FieldLastUsed {
  ...
  **/
   ...
   * @return the FieldLastUsed instance itself
   */
  public FieldLastUsed putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, fieldLastUsed.type) &&
        ...
        Objects.equals(this.additionalProperties, fieldLastUsed.additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FieldLastUsed.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<FieldLastUsed>() {
           ...
           public FieldLastUsed read(JsonReader in) throws IOException {
             ...
             FieldLastUsed instance = thisAdapter.fromJsonTree(jsonObj);
