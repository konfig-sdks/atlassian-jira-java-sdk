...
import com.konfigthis.client.model.JqlQueryField;
 ...
 */
@ApiModel(description = "A clause that asserts a previous value of a field. For example, `status WAS \"Resolved\" BY currentUser() BEFORE \"2019/02/02\"`. See [WAS](https://confluence.atlassian.com/x/dgiiLQ#Advancedsearching-operatorsreference-WASWAS) for more information about the WAS operator.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class FieldWasClause {
 ...
 public enum OperatorEnum {
  ...
  private List<CompoundClausePredicatesInner> predicates = new ArrayList<>();
  ...
  **/
  ...
  public FieldWasClause operand(LVFKOperand operand) {
  ...
  **/
  ...
  public FieldWasClause predicates(List<CompoundClausePredicatesInner> predicates) {
  ...
  public FieldWasClause addPredicatesItem(CompoundClausePredicatesInner predicatesItem) {
  ...
  **/
   ...
   * @return the FieldWasClause instance itself
   */
  public FieldWasClause putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.field, fieldWasClause.field) &&
        ...
        Objects.equals(this.additionalProperties, fieldWasClause.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(field, operand, operator, predicates, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FieldWasClause.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<FieldWasClause>() {
           ...
           public FieldWasClause read(JsonReader in) throws IOException {
             ...
             FieldWasClause instance = thisAdapter.fromJsonTree(jsonObj);
