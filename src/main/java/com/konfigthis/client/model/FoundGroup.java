 ...
 */
@ApiModel(description = "A group found in a search.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class FoundGroup {
  ...
  **/
   ...
   * @return the FoundGroup instance itself
   */
  public FoundGroup putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.groupId, foundGroup.groupId) &&
        ...
        Objects.equals(this.additionalProperties, foundGroup.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(groupId, html, labels, name, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FoundGroup.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<FoundGroup>() {
           ...
           public FoundGroup read(JsonReader in) throws IOException {
             ...
             FoundGroup instance = thisAdapter.fromJsonTree(jsonObj);
