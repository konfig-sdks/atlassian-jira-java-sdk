 ...
 */
@ApiModel(description = "An operand that is a function. See [Advanced searching - functions reference](https://confluence.atlassian.com/x/dwiiLQ) for more information about JQL functions.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class FunctionOperand {
  ...
  **/
   ...
   * @return the FunctionOperand instance itself
   */
  public FunctionOperand putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.arguments, functionOperand.arguments) &&
        ...
        Objects.equals(this.additionalProperties, functionOperand.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(arguments, encodedOperand, function, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FunctionOperand.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<FunctionOperand>() {
           ...
           public FunctionOperand read(JsonReader in) throws IOException {
             ...
             FunctionOperand instance = thisAdapter.fromJsonTree(jsonObj);
