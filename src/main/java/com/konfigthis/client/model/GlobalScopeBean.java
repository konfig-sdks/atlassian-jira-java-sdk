...
public class GlobalScopeBean {
  ...
  **/
   ...
   * @return the GlobalScopeBean instance itself
   */
  public GlobalScopeBean putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.attributes, globalScopeBean.attributes)&&
        Objects.equals(this.additionalProperties, globalScopeBean.additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!GlobalScopeBean.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<GlobalScopeBean>() {
           ...
           public GlobalScopeBean read(JsonReader in) throws IOException {
             ...
             GlobalScopeBean instance = thisAdapter.fromJsonTree(jsonObj);
