...
public class Group {
  ...
  **/
  ...
  public Group users(PagedListUserDetailsApplicationUser users) {
  ...
  **/
  ...
  public void setUsers(PagedListUserDetailsApplicationUser users) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(expand, groupId, name, self, users, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      if (jsonObj.get("users") != null && !jsonObj.get("users").isJsonNull()) {
        PagedListUserDetailsApplicationUser.validateJsonObject(jsonObj.getAsJsonObject("users"));
      }
  }
