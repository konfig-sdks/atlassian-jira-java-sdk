 ...
 */
@ApiModel(description = "Jira instance health check results. Deprecated and no longer returned.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class HealthCheckResult {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(description, name, passed, additionalProperties);
  }
