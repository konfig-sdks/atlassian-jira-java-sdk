...
import com.konfigthis.client.model.SimplifiedHierarchyLevel;
 ...
 */
@ApiModel(description = "The project issue type hierarchy.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class Hierarchy {
  ...
  **/
   ...
   * @return the Hierarchy instance itself
   */
  public Hierarchy putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.baseLevelId, hierarchy.baseLevelId) &&
        ...
        Objects.equals(this.additionalProperties, hierarchy.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(baseLevelId, levels, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Hierarchy.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Hierarchy>() {
           ...
           public Hierarchy read(JsonReader in) throws IOException {
             ...
             Hierarchy instance = thisAdapter.fromJsonTree(jsonObj);
