 ...
 */
@ApiModel(description = "Details of user or system associated with a issue history metadata item.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class HistoryMetadataParticipant {
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!HistoryMetadataParticipant.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
