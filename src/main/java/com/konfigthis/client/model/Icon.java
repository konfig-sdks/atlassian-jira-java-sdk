 ...
 */
@ApiModel(description = "An icon. If no icon is defined:   *  for a status icon, no status icon displays in Jira.  *  for the remote object icon, the default link icon displays in Jira.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class Icon {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    Icon icon = (Icon) o;
    return Objects.equals(this.title, icon.title) &&
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Icon.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
