...
public class IncludedFields {
  ...
  **/
   ...
   * @return the IncludedFields instance itself
   */
  public IncludedFields putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.actuallyIncluded, includedFields.actuallyIncluded) &&
        ...
        Objects.equals(this.additionalProperties, includedFields.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(actuallyIncluded, excluded, included, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!IncludedFields.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      if (jsonObj.get("actuallyIncluded") != null && !jsonObj.get("actuallyIncluded").isJsonArray()) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<IncludedFields>() {
           ...
           public IncludedFields read(JsonReader in) throws IOException {
             ...
             IncludedFields instance = thisAdapter.fromJsonTree(jsonObj);
