 ...
 */
@ApiModel(description = "An [issue](https://developer.atlassian.com/cloud/jira/platform/jira-expressions-type-reference#issue) specified by ID or key. All the fields of the issue object are available in the Jira expression.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class IssueContextVariable {
  ...
  **/
   ...
   * @return the IssueContextVariable instance itself
   */
  public IssueContextVariable putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, issueContextVariable.id) &&
        ...
        Objects.equals(this.additionalProperties, issueContextVariable.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, key, type, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!IssueContextVariable.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<IssueContextVariable>() {
           ...
           public IssueContextVariable read(JsonReader in) throws IOException {
             ...
             IssueContextVariable instance = thisAdapter.fromJsonTree(jsonObj);
