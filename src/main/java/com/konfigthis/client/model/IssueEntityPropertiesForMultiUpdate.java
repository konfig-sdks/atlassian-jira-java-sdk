 ...
 */
@ApiModel(description = "An issue ID with entity property values. See [Entity properties](https://developer.atlassian.com/cloud/jira/platform/jira-entity-properties/) for more information.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class IssueEntityPropertiesForMultiUpdate {
  ...
  **/
   ...
   * @return the IssueEntityPropertiesForMultiUpdate instance itself
   */
  public IssueEntityPropertiesForMultiUpdate putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.issueID, issueEntityPropertiesForMultiUpdate.issueID) &&
        ...
        Objects.equals(this.additionalProperties, issueEntityPropertiesForMultiUpdate.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(issueID, properties, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!IssueEntityPropertiesForMultiUpdate.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<IssueEntityPropertiesForMultiUpdate>() {
           ...
           public IssueEntityPropertiesForMultiUpdate read(JsonReader in) throws IOException {
             ...
             IssueEntityPropertiesForMultiUpdate instance = thisAdapter.fromJsonTree(jsonObj);
