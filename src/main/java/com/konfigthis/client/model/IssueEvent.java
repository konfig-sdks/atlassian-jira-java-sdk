 ...
 */
@ApiModel(description = "Details about an issue event.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class IssueEvent {
  ...
  **/
   ...
   * @return the IssueEvent instance itself
   */
  public IssueEvent putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, issueEvent.id) &&
        ...
        Objects.equals(this.additionalProperties, issueEvent.additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<IssueEvent>() {
           ...
           public IssueEvent read(JsonReader in) throws IOException {
             ...
             IssueEvent instance = thisAdapter.fromJsonTree(jsonObj);
