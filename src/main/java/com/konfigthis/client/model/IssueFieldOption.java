 ...
 */
@ApiModel(description = "Details of the options for a select list issue field.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class IssueFieldOption {
  ...
  **/
   ...
   * @return the IssueFieldOption instance itself
   */
  public IssueFieldOption putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.config, issueFieldOption.config) &&
        ...
        Objects.equals(this.additionalProperties, issueFieldOption.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(config, id, properties, value, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!IssueFieldOption.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<IssueFieldOption>() {
           ...
           public IssueFieldOption read(JsonReader in) throws IOException {
             ...
             IssueFieldOption instance = thisAdapter.fromJsonTree(jsonObj);
