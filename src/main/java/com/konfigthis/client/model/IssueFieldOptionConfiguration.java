...
import com.konfigthis.client.model.IssueFieldOptionScopeBean;
 ...
 */
@ApiModel(description = "Details of the projects the option is available in.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class IssueFieldOptionConfiguration {
  ...
  **/
   ...
   * @return the IssueFieldOptionConfiguration instance itself
   */
  public IssueFieldOptionConfiguration putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.attributes, issueFieldOptionConfiguration.attributes) &&
        ...
        Objects.equals(this.additionalProperties, issueFieldOptionConfiguration.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(attributes, scope, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!IssueFieldOptionConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      if (jsonObj.get("scope") != null && !jsonObj.get("scope").isJsonNull()) {
        IssueFieldOptionScopeBean.validateJsonObject(jsonObj.getAsJsonObject("scope"));
      }
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<IssueFieldOptionConfiguration>() {
           ...
           public IssueFieldOptionConfiguration read(JsonReader in) throws IOException {
             ...
             IssueFieldOptionConfiguration instance = thisAdapter.fromJsonTree(jsonObj);
