 ...
 */
@ApiModel(description = "Bulk operation filter details.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class IssueFilterForBulkPropertyDelete {
  ...
  **/
   ...
   * @return the IssueFilterForBulkPropertyDelete instance itself
   */
  public IssueFilterForBulkPropertyDelete putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.currentValue, issueFilterForBulkPropertyDelete.currentValue) &&
        ...
        Objects.equals(this.additionalProperties, issueFilterForBulkPropertyDelete.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(currentValue, entityIds, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!IssueFilterForBulkPropertyDelete.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      if (jsonObj.get("entityIds") != null && !jsonObj.get("entityIds").isJsonArray()) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<IssueFilterForBulkPropertyDelete>() {
           ...
           public IssueFilterForBulkPropertyDelete read(JsonReader in) throws IOException {
             ...
             IssueFilterForBulkPropertyDelete instance = thisAdapter.fromJsonTree(jsonObj);
