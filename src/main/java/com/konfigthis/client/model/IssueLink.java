 ...
 */
@ApiModel(description = "Details of a link between issues.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class IssueLink {
  ...
  **/
   ...
   * @return the IssueLink instance itself
   */
  public IssueLink putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, issueLink.id) &&
        ...
        Objects.equals(this.additionalProperties, issueLink.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, inwardIssue, outwardIssue, self, type, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!IssueLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<IssueLink>() {
           ...
           public IssueLink read(JsonReader in) throws IOException {
             ...
             IssueLink instance = thisAdapter.fromJsonTree(jsonObj);
