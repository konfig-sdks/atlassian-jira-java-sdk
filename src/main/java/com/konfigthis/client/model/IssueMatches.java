...
import com.konfigthis.client.model.IssueMatchesForJQL;
 ...
 */
@ApiModel(description = "A list of matched issues or errors for each JQL query, in the order the JQL queries were passed.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class IssueMatches {
  ...
  **/
   ...
   * @return the IssueMatches instance itself
   */
  public IssueMatches putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.matches, issueMatches.matches)&&
        Objects.equals(this.additionalProperties, issueMatches.additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!IssueMatches.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<IssueMatches>() {
           ...
           public IssueMatches read(JsonReader in) throws IOException {
             ...
             IssueMatches instance = thisAdapter.fromJsonTree(jsonObj);
