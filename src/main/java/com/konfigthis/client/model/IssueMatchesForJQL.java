 ...
 */
@ApiModel(description = "A list of the issues matched to a JQL query or details of errors encountered during matching.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class IssueMatchesForJQL {
  ...
  **/
   ...
   * @return the IssueMatchesForJQL instance itself
   */
  public IssueMatchesForJQL putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.errors, issueMatchesForJQL.errors) &&
        ...
        Objects.equals(this.additionalProperties, issueMatchesForJQL.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(errors, matchedIssues, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!IssueMatchesForJQL.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<IssueMatchesForJQL>() {
           ...
           public IssueMatchesForJQL read(JsonReader in) throws IOException {
             ...
             IssueMatchesForJQL instance = thisAdapter.fromJsonTree(jsonObj);
