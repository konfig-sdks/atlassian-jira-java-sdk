 ...
 */
@ApiModel(description = "Details about an issue type.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class IssueTypeDetails {
  ...
  **/
  ...
  public IssueTypeDetails scope(Scope scope) {
  ...
  **/
   ...
   * @return the IssueTypeDetails instance itself
   */
  public IssueTypeDetails putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, issueTypeDetails.description) &&
        ...
        Objects.equals(this.additionalProperties, issueTypeDetails.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, avatarId, entityId, hierarchyLevel, iconUrl, id, name, scope, self, subtask, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!IssueTypeDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<IssueTypeDetails>() {
           ...
           public IssueTypeDetails read(JsonReader in) throws IOException {
             ...
             IssueTypeDetails instance = thisAdapter.fromJsonTree(jsonObj);
