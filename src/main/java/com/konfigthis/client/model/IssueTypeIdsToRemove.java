 ...
 */
@ApiModel(description = "The list of issue type IDs to be removed from the field configuration scheme.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class IssueTypeIdsToRemove {
  ...
  **/
   ...
   * @return the IssueTypeIdsToRemove instance itself
   */
  public IssueTypeIdsToRemove putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.issueTypeIds, issueTypeIdsToRemove.issueTypeIds)&&
        Objects.equals(this.additionalProperties, issueTypeIdsToRemove.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(issueTypeIds, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!IssueTypeIdsToRemove.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<IssueTypeIdsToRemove>() {
           ...
           public IssueTypeIdsToRemove read(JsonReader in) throws IOException {
             ...
             IssueTypeIdsToRemove instance = thisAdapter.fromJsonTree(jsonObj);
