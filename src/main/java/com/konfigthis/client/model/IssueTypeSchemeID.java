 ...
 */
@ApiModel(description = "The ID of an issue type scheme.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class IssueTypeSchemeID {
  ...
  **/
   ...
   * @return the IssueTypeSchemeID instance itself
   */
  public IssueTypeSchemeID putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.issueTypeSchemeId, issueTypeSchemeID.issueTypeSchemeId)&&
        Objects.equals(this.additionalProperties, issueTypeSchemeID.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(issueTypeSchemeId, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!IssueTypeSchemeID.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<IssueTypeSchemeID>() {
           ...
           public IssueTypeSchemeID read(JsonReader in) throws IOException {
             ...
             IssueTypeSchemeID instance = thisAdapter.fromJsonTree(jsonObj);
