 ...
 */
@ApiModel(description = "Issue type scheme item.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class IssueTypeSchemeMapping {
  ...
  **/
   ...
   * @return the IssueTypeSchemeMapping instance itself
   */
  public IssueTypeSchemeMapping putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.issueTypeId, issueTypeSchemeMapping.issueTypeId) &&
        ...
        Objects.equals(this.additionalProperties, issueTypeSchemeMapping.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(issueTypeId, issueTypeSchemeId, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!IssueTypeSchemeMapping.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<IssueTypeSchemeMapping>() {
           ...
           public IssueTypeSchemeMapping read(JsonReader in) throws IOException {
             ...
             IssueTypeSchemeMapping instance = thisAdapter.fromJsonTree(jsonObj);
