...
import com.konfigthis.client.model.IssueTypeScheme;
 ...
 */
@ApiModel(description = "Issue type scheme with a list of the projects that use it.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class IssueTypeSchemeProjects {
  ...
  **/
   ...
   * @return the IssueTypeSchemeProjects instance itself
   */
  public IssueTypeSchemeProjects putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.issueTypeScheme, issueTypeSchemeProjects.issueTypeScheme) &&
        ...
        Objects.equals(this.additionalProperties, issueTypeSchemeProjects.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(issueTypeScheme, projectIds, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!IssueTypeSchemeProjects.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      IssueTypeScheme.validateJsonObject(jsonObj.getAsJsonObject("issueTypeScheme"));
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<IssueTypeSchemeProjects>() {
           ...
           public IssueTypeSchemeProjects read(JsonReader in) throws IOException {
             ...
             IssueTypeSchemeProjects instance = thisAdapter.fromJsonTree(jsonObj);
