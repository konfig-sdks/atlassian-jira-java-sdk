 ...
 */
@ApiModel(description = "Mapping of an issue type to a context.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class IssueTypeToContextMapping {
  ...
  **/
   ...
   * @return the IssueTypeToContextMapping instance itself
   */
  public IssueTypeToContextMapping putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.contextId, issueTypeToContextMapping.contextId) &&
        ...
        Objects.equals(this.additionalProperties, issueTypeToContextMapping.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(contextId, isAnyIssueType, issueTypeId, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!IssueTypeToContextMapping.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<IssueTypeToContextMapping>() {
           ...
           public IssueTypeToContextMapping read(JsonReader in) throws IOException {
             ...
             IssueTypeToContextMapping instance = thisAdapter.fromJsonTree(jsonObj);
