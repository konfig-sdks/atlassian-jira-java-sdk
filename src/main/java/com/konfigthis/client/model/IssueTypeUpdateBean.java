...
public class IssueTypeUpdateBean {
  ...
  **/
   ...
   * @return the IssueTypeUpdateBean instance itself
   */
  public IssueTypeUpdateBean putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, issueTypeUpdateBean.description) &&
        Objects.equals(this.avatarId, issueTypeUpdateBean.avatarId) &&
        Objects.equals(this.name, issueTypeUpdateBean.name)&&
        Objects.equals(this.additionalProperties, issueTypeUpdateBean.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, avatarId, name, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!IssueTypeUpdateBean.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<IssueTypeUpdateBean>() {
           ...
           public IssueTypeUpdateBean read(JsonReader in) throws IOException {
             ...
             IssueTypeUpdateBean instance = thisAdapter.fromJsonTree(jsonObj);
