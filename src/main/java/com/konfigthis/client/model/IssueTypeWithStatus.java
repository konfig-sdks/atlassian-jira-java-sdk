 ...
 */
@ApiModel(description = "Status details for an issue type.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class IssueTypeWithStatus {
  ...
  **/
   ...
   * @return the IssueTypeWithStatus instance itself
   */
  public IssueTypeWithStatus putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, issueTypeWithStatus.id) &&
        ...
        Objects.equals(this.additionalProperties, issueTypeWithStatus.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, name, self, statuses, subtask, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!IssueTypeWithStatus.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (int i = 0; i < jsonArraystatuses.size(); i++) {
        StatusDetails.validateJsonObject(jsonArraystatuses.get(i).getAsJsonObject());
      };
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<IssueTypeWithStatus>() {
           ...
           public IssueTypeWithStatus read(JsonReader in) throws IOException {
             ...
             IssueTypeWithStatus instance = thisAdapter.fromJsonTree(jsonObj);
