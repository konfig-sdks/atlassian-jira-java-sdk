...
public class IssuesUpdateBean {
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!IssuesUpdateBean.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      if (jsonObj.get("issueUpdates") != null && !jsonObj.get("issueUpdates").isJsonNull()) {
        JsonArray jsonArrayissueUpdates = jsonObj.getAsJsonArray("issueUpdates");
        if (jsonArrayissueUpdates != null) {
          // ensure the json data is an array
          if (!jsonObj.get("issueUpdates").isJsonArray()) {
          ...
          // validate the optional field `issueUpdates` (array)
          for (int i = 0; i < jsonArrayissueUpdates.size(); i++) {
            IssueUpdateDetails.validateJsonObject(jsonArrayissueUpdates.get(i).getAsJsonObject());
          };
        }
      }
  }
