 ...
 */
@ApiModel(description = "The JQL queries to be converted.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class JQLPersonalDataMigrationRequest {
  ...
  **/
   ...
   * @return the JQLPersonalDataMigrationRequest instance itself
   */
  public JQLPersonalDataMigrationRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.queryStrings, jqLPersonalDataMigrationRequest.queryStrings)&&
        Objects.equals(this.additionalProperties, jqLPersonalDataMigrationRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(queryStrings, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!JQLPersonalDataMigrationRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<JQLPersonalDataMigrationRequest>() {
           ...
           public JQLPersonalDataMigrationRequest read(JsonReader in) throws IOException {
             ...
             JQLPersonalDataMigrationRequest instance = thisAdapter.fromJsonTree(jsonObj);
