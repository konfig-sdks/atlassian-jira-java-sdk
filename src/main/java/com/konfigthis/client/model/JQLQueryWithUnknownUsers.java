 ...
 */
@ApiModel(description = "JQL queries that contained users that could not be found")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class JQLQueryWithUnknownUsers {
  ...
  **/
   ...
   * @return the JQLQueryWithUnknownUsers instance itself
   */
  public JQLQueryWithUnknownUsers putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.convertedQuery, jqLQueryWithUnknownUsers.convertedQuery) &&
        ...
        Objects.equals(this.additionalProperties, jqLQueryWithUnknownUsers.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(convertedQuery, originalQuery, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!JQLQueryWithUnknownUsers.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<JQLQueryWithUnknownUsers>() {
           ...
           public JQLQueryWithUnknownUsers read(JsonReader in) throws IOException {
             ...
             JQLQueryWithUnknownUsers instance = thisAdapter.fromJsonTree(jsonObj);
