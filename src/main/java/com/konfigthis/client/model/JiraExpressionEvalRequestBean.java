...
public class JiraExpressionEvalRequestBean {
  ...
  **/
   ...
   * @return the JiraExpressionEvalRequestBean instance itself
   */
  public JiraExpressionEvalRequestBean putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.context, jiraExpressionEvalRequestBean.context) &&
        ...
        Objects.equals(this.additionalProperties, jiraExpressionEvalRequestBean.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(context, expression, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!JiraExpressionEvalRequestBean.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      if (jsonObj.get("context") != null && !jsonObj.get("context").isJsonNull()) {
        JiraExpressionEvalContextBean.validateJsonObject(jsonObj.getAsJsonObject("context"));
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<JiraExpressionEvalRequestBean>() {
           ...
           public JiraExpressionEvalRequestBean read(JsonReader in) throws IOException {
             ...
             JiraExpressionEvalRequestBean instance = thisAdapter.fromJsonTree(jsonObj);
