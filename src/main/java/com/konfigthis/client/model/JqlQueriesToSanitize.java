 ...
 */
@ApiModel(description = "The list of JQL queries to sanitize for the given account IDs.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class JqlQueriesToSanitize {
  ...
  **/
   ...
   * @return the JqlQueriesToSanitize instance itself
   */
  public JqlQueriesToSanitize putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.queries, jqlQueriesToSanitize.queries)&&
        Objects.equals(this.additionalProperties, jqlQueriesToSanitize.additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!JqlQueriesToSanitize.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<JqlQueriesToSanitize>() {
           ...
           public JqlQueriesToSanitize read(JsonReader in) throws IOException {
             ...
             JqlQueriesToSanitize instance = thisAdapter.fromJsonTree(jsonObj);
