...
public class JqlQueryClause {
   ...
   * @return the JqlQueryClause instance itself
   */
  public JqlQueryClause putAdditionalProperty(String key, Object value) {
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!JqlQueryClause.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in JqlQueryClause is not found in the empty JSON string", JqlQueryClause.openapiRequiredFields.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       final TypeAdapter<JqlQueryClause> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(JqlQueryClause.class));
       ...
       return (TypeAdapter<T>) new TypeAdapter<JqlQueryClause>() {
           ...
           public JqlQueryClause read(JsonReader in) throws IOException {
             ...
             JqlQueryClause instance = thisAdapter.fromJsonTree(jsonObj);
