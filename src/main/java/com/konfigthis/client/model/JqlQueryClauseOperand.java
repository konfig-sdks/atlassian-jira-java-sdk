...
public class JqlQueryClauseOperand {
   ...
   * @return the JqlQueryClauseOperand instance itself
   */
  public JqlQueryClauseOperand putAdditionalProperty(String key, Object value) {
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!JqlQueryClauseOperand.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in JqlQueryClauseOperand is not found in the empty JSON string", JqlQueryClauseOperand.openapiRequiredFields.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       final TypeAdapter<JqlQueryClauseOperand> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(JqlQueryClauseOperand.class));
       ...
       return (TypeAdapter<T>) new TypeAdapter<JqlQueryClauseOperand>() {
           ...
           public JqlQueryClauseOperand read(JsonReader in) throws IOException {
             ...
             JqlQueryClauseOperand instance = thisAdapter.fromJsonTree(jsonObj);
