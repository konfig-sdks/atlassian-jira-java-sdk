...
public class JqlQueryClauseTimePredicate {
 ...
 public enum OperatorEnum {
  ...
  public JqlQueryClauseTimePredicate operand(LVFKOperand operand) {
  ...
  **/
   ...
   * @return the JqlQueryClauseTimePredicate instance itself
   */
  public JqlQueryClauseTimePredicate putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.operand, jqlQueryClauseTimePredicate.operand) &&
        ...
        Objects.equals(this.additionalProperties, jqlQueryClauseTimePredicate.additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!JqlQueryClauseTimePredicate.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<JqlQueryClauseTimePredicate>() {
           ...
           public JqlQueryClauseTimePredicate read(JsonReader in) throws IOException {
             ...
             JqlQueryClauseTimePredicate instance = thisAdapter.fromJsonTree(jsonObj);
