 ...
 */
@ApiModel(description = "The JQL query to sanitize for the account ID. If the account ID is null, sanitizing is performed for an anonymous user.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class JqlQueryToSanitize {
  ...
  **/
   ...
   * @return the JqlQueryToSanitize instance itself
   */
  public JqlQueryToSanitize putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accountId, jqlQueryToSanitize.accountId) &&
        ...
        Objects.equals(this.additionalProperties, jqlQueryToSanitize.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accountId, query, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!JqlQueryToSanitize.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<JqlQueryToSanitize>() {
           ...
           public JqlQueryToSanitize read(JsonReader in) throws IOException {
             ...
             JqlQueryToSanitize instance = thisAdapter.fromJsonTree(jsonObj);
