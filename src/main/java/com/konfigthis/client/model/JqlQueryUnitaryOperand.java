...
public class JqlQueryUnitaryOperand {
   ...
   * @return the JqlQueryUnitaryOperand instance itself
   */
  public JqlQueryUnitaryOperand putAdditionalProperty(String key, Object value) {
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!JqlQueryUnitaryOperand.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in JqlQueryUnitaryOperand is not found in the empty JSON string", JqlQueryUnitaryOperand.openapiRequiredFields.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       final TypeAdapter<JqlQueryUnitaryOperand> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(JqlQueryUnitaryOperand.class));
       ...
       return (TypeAdapter<T>) new TypeAdapter<JqlQueryUnitaryOperand>() {
           ...
           public JqlQueryUnitaryOperand read(JsonReader in) throws IOException {
             ...
             JqlQueryUnitaryOperand instance = thisAdapter.fromJsonTree(jsonObj);
