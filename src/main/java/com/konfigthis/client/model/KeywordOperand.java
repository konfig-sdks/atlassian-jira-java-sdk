 ...
 */
@ApiModel(description = "An operand that is a JQL keyword. See [Advanced searching - keywords reference](https://confluence.atlassian.com/jiracorecloud/advanced-searching-keywords-reference-765593717.html#Advancedsearching-keywordsreference-EMPTYEMPTY) for more information about operand keywords.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class KeywordOperand {
  ...
  **/
   ...
   * @return the KeywordOperand instance itself
   */
  public KeywordOperand putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.keyword, keywordOperand.keyword)&&
        Objects.equals(this.additionalProperties, keywordOperand.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(keyword, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!KeywordOperand.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<KeywordOperand>() {
           ...
           public KeywordOperand read(JsonReader in) throws IOException {
             ...
             KeywordOperand instance = thisAdapter.fromJsonTree(jsonObj);
