...
public class LinkIssueRequestJsonBean {
  ...
  **/
   ...
   * @return the LinkIssueRequestJsonBean instance itself
   */
  public LinkIssueRequestJsonBean putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.comment, linkIssueRequestJsonBean.comment) &&
        ...
        Objects.equals(this.additionalProperties, linkIssueRequestJsonBean.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(comment, inwardIssue, outwardIssue, type, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LinkIssueRequestJsonBean.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<LinkIssueRequestJsonBean>() {
           ...
           public LinkIssueRequestJsonBean read(JsonReader in) throws IOException {
             ...
             LinkIssueRequestJsonBean instance = thisAdapter.fromJsonTree(jsonObj);
