...
public class MappingsByIssueTypeOverride {
  ...
  **/
   ...
   * @return the MappingsByIssueTypeOverride instance itself
   */
  public MappingsByIssueTypeOverride putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.issueTypeId, mappingsByIssueTypeOverride.issueTypeId) &&
        ...
        Objects.equals(this.additionalProperties, mappingsByIssueTypeOverride.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(issueTypeId, statusMappings, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to MappingsByIssueTypeOverride
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!MappingsByIssueTypeOverride.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<MappingsByIssueTypeOverride>() {
           ...
           public MappingsByIssueTypeOverride read(JsonReader in) throws IOException {
             ...
             MappingsByIssueTypeOverride instance = thisAdapter.fromJsonTree(jsonObj);
