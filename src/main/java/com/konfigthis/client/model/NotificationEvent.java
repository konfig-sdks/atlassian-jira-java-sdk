 ...
 */
@ApiModel(description = "Details about a notification event.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class NotificationEvent {
  ...
  **/
   ...
   * @return the NotificationEvent instance itself
   */
  public NotificationEvent putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, notificationEvent.description) &&
        ...
        Objects.equals(this.additionalProperties, notificationEvent.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, id, name, templateEvent, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!NotificationEvent.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      if (jsonObj.get("templateEvent") != null && !jsonObj.get("templateEvent").isJsonNull()) {
        NotificationEvent.validateJsonObject(jsonObj.getAsJsonObject("templateEvent"));
      }
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<NotificationEvent>() {
           ...
           public NotificationEvent read(JsonReader in) throws IOException {
             ...
             NotificationEvent instance = thisAdapter.fromJsonTree(jsonObj);
