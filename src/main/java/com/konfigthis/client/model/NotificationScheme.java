 ...
 */
@ApiModel(description = "Details about a notification scheme.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class NotificationScheme {
  ...
  **/
   ...
   * @return the NotificationScheme instance itself
   */
  public NotificationScheme putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, notificationScheme.description) &&
        ...
        Objects.equals(this.additionalProperties, notificationScheme.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, expand, id, name, notificationSchemeEvents, projects, scope, self, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<NotificationScheme>() {
           ...
           public NotificationScheme read(JsonReader in) throws IOException {
             ...
             NotificationScheme instance = thisAdapter.fromJsonTree(jsonObj);
