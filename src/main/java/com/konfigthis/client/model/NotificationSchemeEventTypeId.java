 ...
 */
@ApiModel(description = "The ID of an event that is being mapped to notifications.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class NotificationSchemeEventTypeId {
  ...
  * @throws IOException if the JSON Object is invalid with respect to NotificationSchemeEventTypeId
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!NotificationSchemeEventTypeId.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
