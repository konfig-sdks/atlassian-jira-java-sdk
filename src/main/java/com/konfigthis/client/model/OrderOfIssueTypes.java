 ...
 */
@ApiModel(description = "An ordered list of issue type IDs and information about where to move them.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class OrderOfIssueTypes {
  ...
  **/
   ...
   * @return the OrderOfIssueTypes instance itself
   */
  public OrderOfIssueTypes putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.after, orderOfIssueTypes.after) &&
        ...
        Objects.equals(this.additionalProperties, orderOfIssueTypes.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(after, issueTypeIds, position, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!OrderOfIssueTypes.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<OrderOfIssueTypes>() {
           ...
           public OrderOfIssueTypes read(JsonReader in) throws IOException {
             ...
             OrderOfIssueTypes instance = thisAdapter.fromJsonTree(jsonObj);
