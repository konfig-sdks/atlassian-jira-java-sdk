...
import com.konfigthis.client.model.ContextForProjectAndIssueType;
...
public class PageBeanContextForProjectAndIssueType {
  ...
  **/
   ...
   * @return the PageBeanContextForProjectAndIssueType instance itself
   */
  public PageBeanContextForProjectAndIssueType putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.isLast, pageBeanContextForProjectAndIssueType.isLast) &&
        ...
        Objects.equals(this.additionalProperties, pageBeanContextForProjectAndIssueType.additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PageBeanContextForProjectAndIssueType.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<PageBeanContextForProjectAndIssueType>() {
           ...
           public PageBeanContextForProjectAndIssueType read(JsonReader in) throws IOException {
             ...
             PageBeanContextForProjectAndIssueType instance = thisAdapter.fromJsonTree(jsonObj);
