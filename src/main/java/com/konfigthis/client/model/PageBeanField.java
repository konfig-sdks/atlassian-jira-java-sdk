...
public class PageBeanField {
  ...
  **/
   ...
   * @return the PageBeanField instance itself
   */
  public PageBeanField putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.isLast, pageBeanField.isLast) &&
        ...
        Objects.equals(this.additionalProperties, pageBeanField.additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PageBeanField.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<PageBeanField>() {
           ...
           public PageBeanField read(JsonReader in) throws IOException {
             ...
             PageBeanField instance = thisAdapter.fromJsonTree(jsonObj);
