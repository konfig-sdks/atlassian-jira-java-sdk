 ...
 */
@ApiModel(description = "A page of changelogs.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class PageOfChangelogs {
  ...
  **/
   ...
   * @return the PageOfChangelogs instance itself
   */
  public PageOfChangelogs putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.histories, pageOfChangelogs.histories) &&
        ...
        Objects.equals(this.additionalProperties, pageOfChangelogs.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(histories, maxResults, startAt, total, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PageOfChangelogs.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<PageOfChangelogs>() {
           ...
           public PageOfChangelogs read(JsonReader in) throws IOException {
             ...
             PageOfChangelogs instance = thisAdapter.fromJsonTree(jsonObj);
