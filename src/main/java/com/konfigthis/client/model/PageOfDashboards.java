 ...
 */
@ApiModel(description = "A page containing dashboard details.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class PageOfDashboards {
  ...
  **/
   ...
   * @return the PageOfDashboards instance itself
   */
  public PageOfDashboards putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.dashboards, pageOfDashboards.dashboards) &&
        ...
        Objects.equals(this.additionalProperties, pageOfDashboards.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(dashboards, maxResults, next, prev, startAt, total, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PageOfDashboards.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<PageOfDashboards>() {
           ...
           public PageOfDashboards read(JsonReader in) throws IOException {
             ...
             PageOfDashboards instance = thisAdapter.fromJsonTree(jsonObj);
