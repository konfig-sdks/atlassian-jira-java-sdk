...
public class PageOfStatuses {
  ...
  **/
   ...
   * @return the PageOfStatuses instance itself
   */
  public PageOfStatuses putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.isLast, pageOfStatuses.isLast) &&
        ...
        Objects.equals(this.additionalProperties, pageOfStatuses.additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<PageOfStatuses>() {
           ...
           public PageOfStatuses read(JsonReader in) throws IOException {
             ...
             PageOfStatuses instance = thisAdapter.fromJsonTree(jsonObj);
