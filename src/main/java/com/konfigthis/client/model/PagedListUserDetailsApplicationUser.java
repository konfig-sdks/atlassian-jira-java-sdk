 ...
 */
@ApiModel(description = "A paged list. To access additional details append `[start-index:end-index]` to the expand request. For example, `?expand=sharedUsers[10:40]` returns a list starting at item 10 and finishing at item 40.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class PagedListUserDetailsApplicationUser {
  ...
  **/
   ...
   * @return the PagedListUserDetailsApplicationUser instance itself
   */
  public PagedListUserDetailsApplicationUser putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.endIndex, pagedListUserDetailsApplicationUser.endIndex) &&
        ...
        Objects.equals(this.additionalProperties, pagedListUserDetailsApplicationUser.additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PagedListUserDetailsApplicationUser.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<PagedListUserDetailsApplicationUser>() {
           ...
           public PagedListUserDetailsApplicationUser read(JsonReader in) throws IOException {
             ...
             PagedListUserDetailsApplicationUser instance = thisAdapter.fromJsonTree(jsonObj);
