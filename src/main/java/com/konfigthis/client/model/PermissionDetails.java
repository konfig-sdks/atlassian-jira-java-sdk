 ...
 */
@ApiModel(description = "Details for permissions of shareable entities")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class PermissionDetails {
  ...
  **/
   ...
   * @return the PermissionDetails instance itself
   */
  public PermissionDetails putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.editPermissions, permissionDetails.editPermissions) &&
        ...
        Objects.equals(this.additionalProperties, permissionDetails.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(editPermissions, sharePermissions, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to PermissionDetails
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PermissionDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<PermissionDetails>() {
           ...
           public PermissionDetails read(JsonReader in) throws IOException {
             ...
             PermissionDetails instance = thisAdapter.fromJsonTree(jsonObj);
