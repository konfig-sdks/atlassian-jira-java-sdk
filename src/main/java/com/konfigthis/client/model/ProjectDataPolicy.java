...
public class ProjectDataPolicy {
  ...
  **/
   ...
   * @return the ProjectDataPolicy instance itself
   */
  public ProjectDataPolicy putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.anyContentBlocked, projectDataPolicy.anyContentBlocked)&&
        Objects.equals(this.additionalProperties, projectDataPolicy.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ProjectDataPolicy
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ProjectDataPolicy.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ProjectDataPolicy>() {
           ...
           public ProjectDataPolicy read(JsonReader in) throws IOException {
             ...
             ProjectDataPolicy instance = thisAdapter.fromJsonTree(jsonObj);
