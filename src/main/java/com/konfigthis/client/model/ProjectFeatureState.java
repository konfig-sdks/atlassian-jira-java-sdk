 ...
 */
@ApiModel(description = "Details of the feature state.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ProjectFeatureState {
  ...
  **/
   ...
   * @return the ProjectFeatureState instance itself
   */
  public ProjectFeatureState putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.state, projectFeatureState.state)&&
        Objects.equals(this.additionalProperties, projectFeatureState.additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ProjectFeatureState.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ProjectFeatureState>() {
           ...
           public ProjectFeatureState read(JsonReader in) throws IOException {
             ...
             ProjectFeatureState instance = thisAdapter.fromJsonTree(jsonObj);
