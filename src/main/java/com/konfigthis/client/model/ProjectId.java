 ...
 * Project ID details.
 */
@ApiModel(description = "Project ID details.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ProjectId {
  ...
  **/
   ...
   * @return the ProjectId instance itself
   */
  public ProjectId putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, projectId.id)&&
        Objects.equals(this.additionalProperties, projectId.additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ProjectId.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ProjectId>() {
           ...
           public ProjectId read(JsonReader in) throws IOException {
             ...
             ProjectId instance = thisAdapter.fromJsonTree(jsonObj);
