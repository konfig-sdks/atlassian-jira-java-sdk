 ...
 */
@ApiModel(description = "Additional details about a project.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ProjectInsight {
  ...
  **/
   ...
   * @return the ProjectInsight instance itself
   */
  public ProjectInsight putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.lastIssueUpdateTime, projectInsight.lastIssueUpdateTime) &&
        ...
        Objects.equals(this.additionalProperties, projectInsight.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(lastIssueUpdateTime, totalIssueCount, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ProjectInsight.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ProjectInsight>() {
           ...
           public ProjectInsight read(JsonReader in) throws IOException {
             ...
             ProjectInsight instance = thisAdapter.fromJsonTree(jsonObj);
