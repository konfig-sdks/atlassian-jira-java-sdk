...
import com.konfigthis.client.model.ProjectId;
 ...
 */
@ApiModel(description = "Use the optional `workflows.usages` expand to get additional information about the projects and issue types associated with the requested workflows.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ProjectIssueTypes {
  ...
  **/
   ...
   * @return the ProjectIssueTypes instance itself
   */
  public ProjectIssueTypes putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.issueTypes, projectIssueTypes.issueTypes) &&
        ...
        Objects.equals(this.additionalProperties, projectIssueTypes.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(issueTypes, project, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      if (jsonObj.get("issueTypes") != null && !jsonObj.get("issueTypes").isJsonNull() && !jsonObj.get("issueTypes").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `issueTypes` to be an array in the JSON string or null but got `%s`", jsonObj.get("issueTypes").toString()));
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ProjectIssueTypes>() {
           ...
           public ProjectIssueTypes read(JsonReader in) throws IOException {
             ...
             ProjectIssueTypes instance = thisAdapter.fromJsonTree(jsonObj);
