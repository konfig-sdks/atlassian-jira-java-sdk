 ...
 */
@ApiModel(description = "Permissions which a user has on a project.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ProjectPermissions {
  ...
  **/
   ...
   * @return the ProjectPermissions instance itself
   */
  public ProjectPermissions putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.canEdit, projectPermissions.canEdit)&&
        Objects.equals(this.additionalProperties, projectPermissions.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(canEdit, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ProjectPermissions.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ProjectPermissions>() {
           ...
           public ProjectPermissions read(JsonReader in) throws IOException {
             ...
             ProjectPermissions instance = thisAdapter.fromJsonTree(jsonObj);
