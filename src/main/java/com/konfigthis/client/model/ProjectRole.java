 ...
 */
@ApiModel(description = "Details about the roles in a project.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ProjectRole {
  ...
  **/
  ...
  public ProjectRole scope(Scope scope) {
  ...
  **/
   ...
   * @return the ProjectRole instance itself
   */
  public ProjectRole putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, projectRole.description) &&
        ...
        Objects.equals(this.additionalProperties, projectRole.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, actors, admin, currentUserRole, _default, id, name, roleConfigurable, scope, self, translatedName, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ProjectRole.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ProjectRole>() {
           ...
           public ProjectRole read(JsonReader in) throws IOException {
             ...
             ProjectRole instance = thisAdapter.fromJsonTree(jsonObj);
