 ...
 */
@ApiModel(description = "Details of the user associated with the role.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ProjectRoleUser {
  ...
  **/
   ...
   * @return the ProjectRoleUser instance itself
   */
  public ProjectRoleUser putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accountId, projectRoleUser.accountId)&&
        Objects.equals(this.additionalProperties, projectRoleUser.additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ProjectRoleUser.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ProjectRoleUser>() {
           ...
           public ProjectRoleUser read(JsonReader in) throws IOException {
             ...
             ProjectRoleUser instance = thisAdapter.fromJsonTree(jsonObj);
