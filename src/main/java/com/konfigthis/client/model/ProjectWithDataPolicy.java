...
import com.konfigthis.client.model.ProjectDataPolicy;
 ...
 */
@ApiModel(description = "Details about data policies for a project.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ProjectWithDataPolicy {
  ...
  public ProjectWithDataPolicy dataPolicy(ProjectDataPolicy dataPolicy) {
  ...
  **/
  ...
  public void setDataPolicy(ProjectDataPolicy dataPolicy) {
  ...
  **/
   ...
   * @return the ProjectWithDataPolicy instance itself
   */
  public ProjectWithDataPolicy putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.dataPolicy, projectWithDataPolicy.dataPolicy) &&
        ...
        Objects.equals(this.additionalProperties, projectWithDataPolicy.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(dataPolicy, id, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ProjectWithDataPolicy
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ProjectWithDataPolicy.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      if (jsonObj.get("dataPolicy") != null && !jsonObj.get("dataPolicy").isJsonNull()) {
        ProjectDataPolicy.validateJsonObject(jsonObj.getAsJsonObject("dataPolicy"));
      }
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ProjectWithDataPolicy>() {
           ...
           public ProjectWithDataPolicy read(JsonReader in) throws IOException {
             ...
             ProjectWithDataPolicy instance = thisAdapter.fromJsonTree(jsonObj);
