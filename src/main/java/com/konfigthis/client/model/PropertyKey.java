 ...
 */
@ApiModel(description = "Property key details.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class PropertyKey {
  ...
  **/
   ...
   * @return the PropertyKey instance itself
   */
  public PropertyKey putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.key, propertyKey.key) &&
        ...
        Objects.equals(this.additionalProperties, propertyKey.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(key, self, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PropertyKey.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<PropertyKey>() {
           ...
           public PropertyKey read(JsonReader in) throws IOException {
             ...
             PropertyKey instance = thisAdapter.fromJsonTree(jsonObj);
