 ...
 */
@ApiModel(description = "Details about the status mappings for publishing a draft workflow scheme.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class PublishDraftWorkflowScheme {
  ...
  **/
   ...
   * @return the PublishDraftWorkflowScheme instance itself
   */
  public PublishDraftWorkflowScheme putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.statusMappings, publishDraftWorkflowScheme.statusMappings)&&
        Objects.equals(this.additionalProperties, publishDraftWorkflowScheme.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(statusMappings, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PublishDraftWorkflowScheme.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<PublishDraftWorkflowScheme>() {
           ...
           public PublishDraftWorkflowScheme read(JsonReader in) throws IOException {
             ...
             PublishDraftWorkflowScheme instance = thisAdapter.fromJsonTree(jsonObj);
