 ...
 */
@ApiModel(description = "Details of an issue remote link.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class RemoteIssueLink {
  ...
  **/
   ...
   * @return the RemoteIssueLink instance itself
   */
  public RemoteIssueLink putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.application, remoteIssueLink.application) &&
        ...
        Objects.equals(this.additionalProperties, remoteIssueLink.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(application, globalId, id, _object, relationship, self, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<RemoteIssueLink>() {
           ...
           public RemoteIssueLink read(JsonReader in) throws IOException {
             ...
             RemoteIssueLink instance = thisAdapter.fromJsonTree(jsonObj);
