 ...
 */
@ApiModel(description = "Change the order of issue resolutions.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ReorderIssueResolutionsRequest {
  ...
  **/
   ...
   * @return the ReorderIssueResolutionsRequest instance itself
   */
  public ReorderIssueResolutionsRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.after, reorderIssueResolutionsRequest.after) &&
        ...
        Objects.equals(this.additionalProperties, reorderIssueResolutionsRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(after, ids, position, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ReorderIssueResolutionsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ReorderIssueResolutionsRequest>() {
           ...
           public ReorderIssueResolutionsRequest read(JsonReader in) throws IOException {
             ...
             ReorderIssueResolutionsRequest instance = thisAdapter.fromJsonTree(jsonObj);
