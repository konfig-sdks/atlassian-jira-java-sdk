 ...
 */
@ApiModel(description = "The list of required status mappings by issue type.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class RequiredMappingByIssueType {
  ...
  **/
   ...
   * @return the RequiredMappingByIssueType instance itself
   */
  public RequiredMappingByIssueType putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.issueTypeId, requiredMappingByIssueType.issueTypeId) &&
        ...
        Objects.equals(this.additionalProperties, requiredMappingByIssueType.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(issueTypeId, statusIds, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to RequiredMappingByIssueType
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!RequiredMappingByIssueType.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<RequiredMappingByIssueType>() {
           ...
           public RequiredMappingByIssueType read(JsonReader in) throws IOException {
             ...
             RequiredMappingByIssueType instance = thisAdapter.fromJsonTree(jsonObj);
