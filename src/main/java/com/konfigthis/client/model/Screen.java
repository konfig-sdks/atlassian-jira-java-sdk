 ...
 * A screen.
 */
@ApiModel(description = "A screen.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class Screen {
  ...
  **/
   ...
   * @return the Screen instance itself
   */
  public Screen putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, screen.description) &&
        ...
        Objects.equals(this.additionalProperties, screen.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, id, name, scope, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Screen.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Screen>() {
           ...
           public Screen read(JsonReader in) throws IOException {
             ...
             Screen instance = thisAdapter.fromJsonTree(jsonObj);
