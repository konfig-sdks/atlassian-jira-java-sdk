 ...
 * A screen scheme.
 */
@ApiModel(description = "A screen scheme.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ScreenScheme {
  ...
  **/
   ...
   * @return the ScreenScheme instance itself
   */
  public ScreenScheme putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, screenScheme.description) &&
        ...
        Objects.equals(this.additionalProperties, screenScheme.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, id, issueTypeScreenSchemes, name, screens, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ScreenScheme.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      if (jsonObj.get("issueTypeScreenSchemes") != null && !jsonObj.get("issueTypeScreenSchemes").isJsonNull()) {
        PageBeanIssueTypeScreenScheme.validateJsonObject(jsonObj.getAsJsonObject("issueTypeScreenSchemes"));
      }
      ...
      if (jsonObj.get("screens") != null && !jsonObj.get("screens").isJsonNull()) {
        ScreenTypes.validateJsonObject(jsonObj.getAsJsonObject("screens"));
      }
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ScreenScheme>() {
           ...
           public ScreenScheme read(JsonReader in) throws IOException {
             ...
             ScreenScheme instance = thisAdapter.fromJsonTree(jsonObj);
