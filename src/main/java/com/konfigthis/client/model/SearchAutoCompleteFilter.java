 ...
 */
@ApiModel(description = "Details of how to filter and list search auto complete information.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class SearchAutoCompleteFilter {
  ...
  **/
  ...
  @ApiModelProperty(example = "false", value = "Include collapsed fields for fields that have non-unique names.")
  ...
  **/
   ...
   * @return the SearchAutoCompleteFilter instance itself
   */
  public SearchAutoCompleteFilter putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.includeCollapsedFields, searchAutoCompleteFilter.includeCollapsedFields) &&
        ...
        Objects.equals(this.additionalProperties, searchAutoCompleteFilter.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(includeCollapsedFields, projectIds, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SearchAutoCompleteFilter.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<SearchAutoCompleteFilter>() {
           ...
           public SearchAutoCompleteFilter read(JsonReader in) throws IOException {
             ...
             SearchAutoCompleteFilter instance = thisAdapter.fromJsonTree(jsonObj);
