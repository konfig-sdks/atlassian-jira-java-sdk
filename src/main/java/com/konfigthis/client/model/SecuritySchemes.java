 ...
 */
@ApiModel(description = "List of security schemes.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class SecuritySchemes {
  ...
  **/
   ...
   * @return the SecuritySchemes instance itself
   */
  public SecuritySchemes putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.issueSecuritySchemes, securitySchemes.issueSecuritySchemes)&&
        Objects.equals(this.additionalProperties, securitySchemes.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(issueSecuritySchemes, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SecuritySchemes.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<SecuritySchemes>() {
           ...
           public SecuritySchemes read(JsonReader in) throws IOException {
             ...
             SecuritySchemes instance = thisAdapter.fromJsonTree(jsonObj);
