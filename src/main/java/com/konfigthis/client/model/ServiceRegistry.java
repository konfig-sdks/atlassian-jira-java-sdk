...
public class ServiceRegistry {
  ...
  **/
   ...
   * @return the ServiceRegistry instance itself
   */
  public ServiceRegistry putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, serviceRegistry.description) &&
        ...
        Objects.equals(this.additionalProperties, serviceRegistry.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(description, id, name, organizationId, revision, serviceTier, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ServiceRegistry
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ServiceRegistry.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      if (jsonObj.get("serviceTier") != null && !jsonObj.get("serviceTier").isJsonNull()) {
        ServiceRegistryTier.validateJsonObject(jsonObj.getAsJsonObject("serviceTier"));
      }
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ServiceRegistry>() {
           ...
           public ServiceRegistry read(JsonReader in) throws IOException {
             ...
             ServiceRegistry instance = thisAdapter.fromJsonTree(jsonObj);
