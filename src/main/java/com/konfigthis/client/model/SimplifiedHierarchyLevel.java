...
public class SimplifiedHierarchyLevel {
  ...
  **/
   ...
   * @return the SimplifiedHierarchyLevel instance itself
   */
  public SimplifiedHierarchyLevel putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.aboveLevelId, simplifiedHierarchyLevel.aboveLevelId) &&
        ...
        Objects.equals(this.additionalProperties, simplifiedHierarchyLevel.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(aboveLevelId, belowLevelId, externalUuid, hierarchyLevelNumber, id, issueTypeIds, level, name, projectConfigurationId, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SimplifiedHierarchyLevel.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<SimplifiedHierarchyLevel>() {
           ...
           public SimplifiedHierarchyLevel read(JsonReader in) throws IOException {
             ...
             SimplifiedHierarchyLevel instance = thisAdapter.fromJsonTree(jsonObj);
