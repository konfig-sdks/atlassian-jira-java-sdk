 ...
 */
@ApiModel(description = "Details of the status being created.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class StatusCreate {
  ...
  **/
   ...
   * @return the StatusCreate instance itself
   */
  public StatusCreate putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, statusCreate.description) &&
        ...
        Objects.equals(this.additionalProperties, statusCreate.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, name, statusCategory, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!StatusCreate.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<StatusCreate>() {
           ...
           public StatusCreate read(JsonReader in) throws IOException {
             ...
             StatusCreate instance = thisAdapter.fromJsonTree(jsonObj);
