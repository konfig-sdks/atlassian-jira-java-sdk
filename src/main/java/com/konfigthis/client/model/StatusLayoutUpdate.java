 ...
 */
@ApiModel(description = "The statuses associated with this workflow.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class StatusLayoutUpdate {
  ...
  * @throws IOException if the JSON Object is invalid with respect to StatusLayoutUpdate
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!StatusLayoutUpdate.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      if (jsonObj.get("layout") != null && !jsonObj.get("layout").isJsonNull()) {
        WorkflowLayout.validateJsonObject(jsonObj.getAsJsonObject("layout"));
      }
