...
public class UserColumnRequestBody {
  ...
  **/
   ...
   * @return the UserColumnRequestBody instance itself
   */
  public UserColumnRequestBody putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.columns, userColumnRequestBody.columns)&&
        Objects.equals(this.additionalProperties, userColumnRequestBody.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to UserColumnRequestBody
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UserColumnRequestBody.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<UserColumnRequestBody>() {
           ...
           public UserColumnRequestBody read(JsonReader in) throws IOException {
             ...
             UserColumnRequestBody instance = thisAdapter.fromJsonTree(jsonObj);
