 ...
 */
@ApiModel(description = "A [user](https://developer.atlassian.com/cloud/jira/platform/jira-expressions-type-reference#user) specified as an Atlassian account ID.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class UserContextVariable {
  ...
  **/
   ...
   * @return the UserContextVariable instance itself
   */
  public UserContextVariable putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accountId, userContextVariable.accountId) &&
        ...
        Objects.equals(this.additionalProperties, userContextVariable.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accountId, type, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UserContextVariable.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<UserContextVariable>() {
           ...
           public UserContextVariable read(JsonReader in) throws IOException {
             ...
             UserContextVariable instance = thisAdapter.fromJsonTree(jsonObj);
