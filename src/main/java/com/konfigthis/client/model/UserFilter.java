 ...
 */
@ApiModel(description = "Filter for a User Picker (single) custom field.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class UserFilter {
  ...
  **/
   ...
   * @return the UserFilter instance itself
   */
  public UserFilter putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.enabled, userFilter.enabled) &&
        ...
        Objects.equals(this.additionalProperties, userFilter.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(enabled, groups, roleIds, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UserFilter.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<UserFilter>() {
           ...
           public UserFilter read(JsonReader in) throws IOException {
             ...
             UserFilter instance = thisAdapter.fromJsonTree(jsonObj);
