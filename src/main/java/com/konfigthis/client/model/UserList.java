 ...
 */
@ApiModel(description = "A paginated list of users sharing the filter. This includes users that are members of the groups or can browse the projects that the filter is shared with.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
