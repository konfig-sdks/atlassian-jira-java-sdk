 ...
 */
@ApiModel(description = "A user found in a search.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class UserPickerUser {
  ...
  **/
   ...
   * @return the UserPickerUser instance itself
   */
  public UserPickerUser putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accountId, userPickerUser.accountId) &&
        ...
        Objects.equals(this.additionalProperties, userPickerUser.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accountId, avatarUrl, displayName, html, key, name, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UserPickerUser.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<UserPickerUser>() {
           ...
           public UserPickerUser read(JsonReader in) throws IOException {
             ...
             UserPickerUser instance = thisAdapter.fromJsonTree(jsonObj);
