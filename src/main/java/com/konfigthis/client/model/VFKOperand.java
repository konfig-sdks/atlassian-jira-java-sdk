 ...
 */
@ApiModel(description = "An operand that is a user-provided value.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class VFKOperand {
 ...
 public enum KeywordEnum {
  ...
  public VFKOperand encodedValue(String encodedValue) {
  ...
  **/
  ...
  public VFKOperand value(String value) {
  ...
  **/
  ...
  public VFKOperand arguments(List<String> arguments) {
  ...
  public VFKOperand addArgumentsItem(String argumentsItem) {
  ...
  **/
  ...
  public VFKOperand encodedOperand(String encodedOperand) {
  ...
  **/
  ...
  public VFKOperand function(String function) {
  ...
  **/
  ...
  public VFKOperand keyword(KeywordEnum keyword) {
  ...
  **/
   ...
   * @return the VFKOperand instance itself
   */
  public VFKOperand putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    VFKOperand vfKOperand = (VFKOperand) o;
    return Objects.equals(this.encodedValue, vfKOperand.encodedValue) &&
        Objects.equals(this.value, vfKOperand.value) &&
        Objects.equals(this.arguments, vfKOperand.arguments) &&
        Objects.equals(this.encodedOperand, vfKOperand.encodedOperand) &&
        Objects.equals(this.function, vfKOperand.function) &&
        Objects.equals(this.keyword, vfKOperand.keyword)&&
        Objects.equals(this.additionalProperties, vfKOperand.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(encodedValue, value, arguments, encodedOperand, function, keyword, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class VFKOperand {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to VFKOperand
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!VFKOperand.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VFKOperand is not found in the empty JSON string", VFKOperand.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VFKOperand.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VFKOperand' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VFKOperand> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VFKOperand.class));

       return (TypeAdapter<T>) new TypeAdapter<VFKOperand>() {
           @Override
           public void write(JsonWriter out, VFKOperand value) throws IOException {
           ...
           @Override
           public VFKOperand read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             VFKOperand instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of VFKOperand given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of VFKOperand
  * @throws IOException if the JSON string is invalid with respect to VFKOperand
  */
  public static VFKOperand fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VFKOperand.class);
  }

 /**
  * Convert an instance of VFKOperand to an JSON string
  *
  * @return JSON string
  */
