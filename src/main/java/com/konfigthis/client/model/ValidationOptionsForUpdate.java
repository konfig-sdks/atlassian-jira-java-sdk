 ...
 */
@ApiModel(description = "The level of validation to return from the API. If no values are provided, the default would return `WARNING` and `ERROR` level validation results.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ValidationOptionsForUpdate {
  ...
  **/
   ...
   * @return the ValidationOptionsForUpdate instance itself
   */
  public ValidationOptionsForUpdate putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.levels, validationOptionsForUpdate.levels)&&
        Objects.equals(this.additionalProperties, validationOptionsForUpdate.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(levels, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ValidationOptionsForUpdate
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ValidationOptionsForUpdate.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ValidationOptionsForUpdate>() {
           ...
           public ValidationOptionsForUpdate read(JsonReader in) throws IOException {
             ...
             ValidationOptionsForUpdate instance = thisAdapter.fromJsonTree(jsonObj);
