 ...
 */
@ApiModel(description = "Counts of the number of issues in various statuses.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class VersionIssuesStatus {
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!VersionIssuesStatus.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
