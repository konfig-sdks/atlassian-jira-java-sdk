 ...
 */
@ApiModel(description = "Associated related work to a version")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class VersionRelatedWork {
  ...
  **/
   ...
   * @return the VersionRelatedWork instance itself
   */
  public VersionRelatedWork putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.title, versionRelatedWork.title) &&
        Objects.equals(this.category, versionRelatedWork.category) &&
        ...
        Objects.equals(this.additionalProperties, versionRelatedWork.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(title, category, issueId, relatedWorkId, url, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to VersionRelatedWork
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!VersionRelatedWork.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<VersionRelatedWork>() {
           ...
           public VersionRelatedWork read(JsonReader in) throws IOException {
             ...
             VersionRelatedWork instance = thisAdapter.fromJsonTree(jsonObj);
