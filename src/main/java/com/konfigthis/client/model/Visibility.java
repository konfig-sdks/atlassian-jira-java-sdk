 ...
 */
@ApiModel(description = "The group or role to which this item is visible.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class Visibility {
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Visibility.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
