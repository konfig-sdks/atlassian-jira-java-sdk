 ...
 */
@ApiModel(description = "The details of votes on an issue.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class Votes {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(hasVoted, self, voters, votes, additionalProperties);
  }
