...
public class WebhookDetails {
  ...
  **/
   ...
   * @return the WebhookDetails instance itself
   */
  public WebhookDetails putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.events, webhookDetails.events) &&
        ...
        Objects.equals(this.additionalProperties, webhookDetails.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(events, fieldIdsFilter, issuePropertyKeysFilter, jqlFilter, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<WebhookDetails>() {
           ...
           public WebhookDetails read(JsonReader in) throws IOException {
             ...
             WebhookDetails instance = thisAdapter.fromJsonTree(jsonObj);
