 ...
 */
@ApiModel(description = "The list of status mappings.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class WorkflowAssociationStatusMapping {
  ...
  **/
   ...
   * @return the WorkflowAssociationStatusMapping instance itself
   */
  public WorkflowAssociationStatusMapping putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.newStatusId, workflowAssociationStatusMapping.newStatusId) &&
        ...
        Objects.equals(this.additionalProperties, workflowAssociationStatusMapping.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(newStatusId, oldStatusId, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to WorkflowAssociationStatusMapping
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WorkflowAssociationStatusMapping.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<WorkflowAssociationStatusMapping>() {
           ...
           public WorkflowAssociationStatusMapping read(JsonReader in) throws IOException {
             ...
             WorkflowAssociationStatusMapping instance = thisAdapter.fromJsonTree(jsonObj);
