 ...
 */
@ApiModel(description = "Properties that identify a workflow.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class WorkflowId {
  ...
  **/
   ...
   * @return the WorkflowId instance itself
   */
  public WorkflowId putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.draft, workflowId.draft) &&
        ...
        Objects.equals(this.additionalProperties, workflowId.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(draft, name, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WorkflowId.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<WorkflowId>() {
           ...
           public WorkflowId read(JsonReader in) throws IOException {
             ...
             WorkflowId instance = thisAdapter.fromJsonTree(jsonObj);
