...
import com.konfigthis.client.model.SimpleUsage;
 ...
 */
@ApiModel(description = "Workflow metadata and usage detail.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class WorkflowMetadataRestModel {
  ...
  **/
   ...
   * @return the WorkflowMetadataRestModel instance itself
   */
  public WorkflowMetadataRestModel putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, workflowMetadataRestModel.description) &&
        ...
        Objects.equals(this.additionalProperties, workflowMetadataRestModel.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, version, id, name, usage, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to WorkflowMetadataRestModel
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WorkflowMetadataRestModel.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (int i = 0; i < jsonArrayusage.size(); i++) {
        SimpleUsage.validateJsonObject(jsonArrayusage.get(i).getAsJsonObject());
      };
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<WorkflowMetadataRestModel>() {
           ...
           public WorkflowMetadataRestModel read(JsonReader in) throws IOException {
             ...
             WorkflowMetadataRestModel instance = thisAdapter.fromJsonTree(jsonObj);
