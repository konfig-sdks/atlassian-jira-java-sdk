 ...
 */
@ApiModel(description = "A collection of transition rules.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class WorkflowRules {
  ...
  **/
   ...
   * @return the WorkflowRules instance itself
   */
  public WorkflowRules putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.conditionsTree, workflowRules.conditionsTree) &&
        ...
        Objects.equals(this.additionalProperties, workflowRules.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(conditionsTree, postFunctions, validators, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WorkflowRules.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<WorkflowRules>() {
           ...
           public WorkflowRules read(JsonReader in) throws IOException {
             ...
             WorkflowRules instance = thisAdapter.fromJsonTree(jsonObj);
