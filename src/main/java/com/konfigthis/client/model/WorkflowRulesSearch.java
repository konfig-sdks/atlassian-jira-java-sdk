 ...
 */
@ApiModel(description = "Details of the workflow and its transition rules.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class WorkflowRulesSearch {
  ...
  **/
   ...
   * @return the WorkflowRulesSearch instance itself
   */
  public WorkflowRulesSearch putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.expand, workflowRulesSearch.expand) &&
        ...
        Objects.equals(this.additionalProperties, workflowRulesSearch.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(expand, ruleIds, workflowEntityId, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WorkflowRulesSearch.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<WorkflowRulesSearch>() {
           ...
           public WorkflowRulesSearch read(JsonReader in) throws IOException {
             ...
             WorkflowRulesSearch instance = thisAdapter.fromJsonTree(jsonObj);
