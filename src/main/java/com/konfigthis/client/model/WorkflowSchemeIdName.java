 ...
 */
@ApiModel(description = "The ID and the name of the workflow scheme.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class WorkflowSchemeIdName {
  ...
  **/
   ...
   * @return the WorkflowSchemeIdName instance itself
   */
  public WorkflowSchemeIdName putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, workflowSchemeIdName.id) &&
        ...
        Objects.equals(this.additionalProperties, workflowSchemeIdName.additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WorkflowSchemeIdName.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<WorkflowSchemeIdName>() {
           ...
           public WorkflowSchemeIdName read(JsonReader in) throws IOException {
             ...
             WorkflowSchemeIdName instance = thisAdapter.fromJsonTree(jsonObj);
