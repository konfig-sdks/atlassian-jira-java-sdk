 ...
 */
@ApiModel(description = "An associated workflow scheme and project.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class WorkflowSchemeProjectAssociation {
  ...
  **/
   ...
   * @return the WorkflowSchemeProjectAssociation instance itself
   */
  public WorkflowSchemeProjectAssociation putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.projectId, workflowSchemeProjectAssociation.projectId) &&
        ...
        Objects.equals(this.additionalProperties, workflowSchemeProjectAssociation.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(projectId, workflowSchemeId, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WorkflowSchemeProjectAssociation.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<WorkflowSchemeProjectAssociation>() {
           ...
           public WorkflowSchemeProjectAssociation read(JsonReader in) throws IOException {
             ...
             WorkflowSchemeProjectAssociation instance = thisAdapter.fromJsonTree(jsonObj);
