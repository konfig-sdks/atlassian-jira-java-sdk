 ...
 */
@ApiModel(description = "The request payload to get the required mappings for updating a workflow scheme.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class WorkflowSchemeUpdateRequiredMappingsRequest {
  ...
  **/
   ...
   * @return the WorkflowSchemeUpdateRequiredMappingsRequest instance itself
   */
  public WorkflowSchemeUpdateRequiredMappingsRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.defaultWorkflowId, workflowSchemeUpdateRequiredMappingsRequest.defaultWorkflowId) &&
        ...
        Objects.equals(this.additionalProperties, workflowSchemeUpdateRequiredMappingsRequest.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(defaultWorkflowId, id, workflowsForIssueTypes, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to WorkflowSchemeUpdateRequiredMappingsRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WorkflowSchemeUpdateRequiredMappingsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      if (!jsonObj.get("defaultWorkflowId").isJsonNull() && (jsonObj.get("defaultWorkflowId") != null && !jsonObj.get("defaultWorkflowId").isJsonNull()) && !jsonObj.get("defaultWorkflowId").isJsonPrimitive()) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<WorkflowSchemeUpdateRequiredMappingsRequest>() {
           ...
           public WorkflowSchemeUpdateRequiredMappingsRequest read(JsonReader in) throws IOException {
             ...
             WorkflowSchemeUpdateRequiredMappingsRequest instance = thisAdapter.fromJsonTree(jsonObj);
