...
public class WorkflowStatusAndPort {
  ...
  **/
   ...
   * @return the WorkflowStatusAndPort instance itself
   */
  public WorkflowStatusAndPort putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.port, workflowStatusAndPort.port) &&
        ...
        Objects.equals(this.additionalProperties, workflowStatusAndPort.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to WorkflowStatusAndPort
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WorkflowStatusAndPort.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<WorkflowStatusAndPort>() {
           ...
           public WorkflowStatusAndPort read(JsonReader in) throws IOException {
             ...
             WorkflowStatusAndPort instance = thisAdapter.fromJsonTree(jsonObj);
