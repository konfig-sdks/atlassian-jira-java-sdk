 ...
 */
@ApiModel(description = "A workflow transition.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class WorkflowTransition {
  ...
  **/
   ...
   * @return the WorkflowTransition instance itself
   */
  public WorkflowTransition putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, workflowTransition.id) &&
        ...
        Objects.equals(this.additionalProperties, workflowTransition.additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WorkflowTransition.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<WorkflowTransition>() {
           ...
           public WorkflowTransition read(JsonReader in) throws IOException {
             ...
             WorkflowTransition instance = thisAdapter.fromJsonTree(jsonObj);
