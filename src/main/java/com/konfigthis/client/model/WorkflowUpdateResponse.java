...
public class WorkflowUpdateResponse {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "If there is a [asynchronous task](https://dac-static.atlassian.com) operation, as a result of this update.")
  ...
  **/
   ...
   * @return the WorkflowUpdateResponse instance itself
   */
  public WorkflowUpdateResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.statuses, workflowUpdateResponse.statuses) &&
        ...
        Objects.equals(this.additionalProperties, workflowUpdateResponse.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(statuses, taskId, workflows, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to WorkflowUpdateResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WorkflowUpdateResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<WorkflowUpdateResponse>() {
           ...
           public WorkflowUpdateResponse read(JsonReader in) throws IOException {
             ...
             WorkflowUpdateResponse instance = thisAdapter.fromJsonTree(jsonObj);
