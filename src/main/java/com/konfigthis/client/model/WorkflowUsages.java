 ...
 */
@ApiModel(description = "The workflows that use this status. Only available if the `workflowUsages` expand is requested.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class WorkflowUsages {
  ...
  **/
   ...
   * @return the WorkflowUsages instance itself
   */
  public WorkflowUsages putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.workflowId, workflowUsages.workflowId) &&
        ...
        Objects.equals(this.additionalProperties, workflowUsages.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(workflowId, workflowName, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to WorkflowUsages
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WorkflowUsages.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<WorkflowUsages>() {
           ...
           public WorkflowUsages read(JsonReader in) throws IOException {
             ...
             WorkflowUsages instance = thisAdapter.fromJsonTree(jsonObj);
