 ...
 */
@ApiModel(description = "The details about a workflow validation error.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class WorkflowValidationError {
  ...
  **/
   ...
   * @return the WorkflowValidationError instance itself
   */
  public WorkflowValidationError putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.code, workflowValidationError.code) &&
        ...
        Objects.equals(this.additionalProperties, workflowValidationError.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(code, elementReference, level, message, type, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to WorkflowValidationError
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WorkflowValidationError.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      if (jsonObj.get("elementReference") != null && !jsonObj.get("elementReference").isJsonNull()) {
        WorkflowElementReference.validateJsonObject(jsonObj.getAsJsonObject("elementReference"));
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<WorkflowValidationError>() {
           ...
           public WorkflowValidationError read(JsonReader in) throws IOException {
             ...
             WorkflowValidationError instance = thisAdapter.fromJsonTree(jsonObj);
