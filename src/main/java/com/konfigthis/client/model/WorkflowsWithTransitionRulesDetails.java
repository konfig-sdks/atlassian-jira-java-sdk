 ...
 */
@ApiModel(description = "Details of workflows and their transition rules to delete.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class WorkflowsWithTransitionRulesDetails {
  ...
  **/
   ...
   * @return the WorkflowsWithTransitionRulesDetails instance itself
   */
  public WorkflowsWithTransitionRulesDetails putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.workflows, workflowsWithTransitionRulesDetails.workflows)&&
        Objects.equals(this.additionalProperties, workflowsWithTransitionRulesDetails.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(workflows, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WorkflowsWithTransitionRulesDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<WorkflowsWithTransitionRulesDetails>() {
           ...
           public WorkflowsWithTransitionRulesDetails read(JsonReader in) throws IOException {
             ...
             WorkflowsWithTransitionRulesDetails instance = thisAdapter.fromJsonTree(jsonObj);
